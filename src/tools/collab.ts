...
import { SENTINEL_FOLDER_NAME as COLLAB_FOLDER_NAME } from "../collab/sentinel.js";
import {
...
const COLLAB_RELEASE_SECTION_DEF: ToolDef = {
...
// ---------------------------------------------------------------------------
// Section-lease helpers (W3 Day 4)
// ---------------------------------------------------------------------------
...
export function registerCollabTools(server: McpServer, config: ServerConfig): ToolEntry[] {
  ...
  // -------------------------------------------------------------------------
  // collab_acquire_section (W3 Day 4)
  // -------------------------------------------------------------------------
  entries.push(
    defineTool(
      server,
  ...
  // -------------------------------------------------------------------------
  // collab_release_section (W3 Day 4)
  // -------------------------------------------------------------------------
  entries.push(
    defineTool(
      server,
