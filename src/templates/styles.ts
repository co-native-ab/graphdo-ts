...
// ---------------------------------------------------------------------------
// Scope flyout styles (login page)
// ---------------------------------------------------------------------------

export const SCOPE_FLYOUT_STYLE = `
    ...
    .scope-toggle:hover { color: ${purple.brand}; background: ${grey.grey1}; }
    .scope-flyout {
      max-height: 0;
      overflow: hidden;
    ...
    .scope-close:hover { color: ${grey.grey4}; }
    .scope-list {
      display: flex;
      flex-direction: column;
      gap: 6px;
    ...
    .scope-row:hover { background: ${grey.grey1}; }
    .scope-row input[type="checkbox"] {
      margin-top: 3px;
      accent-color: ${purple.brand};
      flex-shrink: 0;
    }
    .scope-info { display: flex; flex-direction: column; gap: 1px; }
    .scope-label { font-weight: ${fontWeight.semibold}; color: ${grey.grey4}; }
    .scope-desc { color: ${grey.grey3}; font-size: 0.78rem; }
    .scope-save-btn {
      display: block;
      width: 100%;
    ...
    .scope-save-btn:hover { background: ${purple.minus3}; border-color: ${purple.minus2}; }
    .scope-save-btn:disabled { opacity: 0.5; cursor: not-allowed; }
    @media (prefers-color-scheme: dark) {
      .scope-toggle { color: ${dark.textMuted}; }
      .scope-toggle:hover { color: ${dark.heading}; background: ${dark.surfaceHover}; }
      .scope-flyout.open { border-color: ${dark.border}; }
      .scope-flyout-header { color: ${dark.heading}; }
      .scope-close { color: ${dark.textMuted}; }
      .scope-close:hover { color: ${dark.text}; }
      .scope-row:hover { background: ${dark.surfaceHover}; }
      .scope-label { color: ${dark.text}; }
      .scope-desc { color: ${dark.textMuted}; }
      .scope-save-btn {
        background: ${dark.surfaceHover};
        border-color: ${dark.border};
        color: ${dark.heading};
      }
      .scope-save-btn:hover {
