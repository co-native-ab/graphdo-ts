// Shared hardening helpers for loopback HTTP servers (login, picker, and
// the upcoming collab forms). See `docs/plans/collab-v1.md` §5.4 for the
// threat model and the rationale for each pin.
//
