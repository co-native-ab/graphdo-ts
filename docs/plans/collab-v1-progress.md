...
Last updated: W1 Day 3 — `session_init_project` happy path landed
Current milestone: W1 Day 3 — Module skeleton + `session_init_project` happy path (this PR)
Next milestone: W1 Day 4 — Multi-root-md handling (`16-multiple-root-md.test.ts`)
