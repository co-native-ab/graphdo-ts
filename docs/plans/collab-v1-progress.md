...
Last updated: W1 Day 2 — `ServerConfig.now` + sentinel codec landed
Current milestone: W1 Day 2 — `ServerConfig` extensions + sentinel codec (this PR)
Next milestone: W1 Day 3 — Module skeleton + `session_init_project` happy path
