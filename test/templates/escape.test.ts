...
// `src/templates/{login,picker,logout}.ts` (and, in collab v1, the
// destructive and external re-prompt forms) must pass through. See
// `docs/plans/collab-v1.md` §5.4 item 7 for the rationale.
